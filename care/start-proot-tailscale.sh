#!/usr/bin/env bash
# ==============================================================================
# ⛔ DEPRECATED (2026-08-14) — 단일 노드 전환으로 더 이상 호출 안 됨.
#   helena-proot(proot/glibc, 41641) 노드 제거. 돌봄 연결은 helena-android(bionic,
#   41642) 단일 노드 + state 자동 재연결로 충분. 부팅 스크립트는
#   start-tailscale-boot.sh 가 단일 노드만 기동하며 이 helper를 부르지 않음.
#   → 이 파일은 참고용으로 보존. 재사용하지 말 것.
# ==============================================================================
