...
## 참조 자산 (냉장고)
- APK 빌드 구조: `REDACTED/dtslib-apk-lab`
- MCP 서버 패턴: `REDACTED/parksy-audio/pre-season/mcp_voice/`
- 도면·웹툰 자산: `REDACTED/parksy-image/도면/`, `REDACTED/parksy-image/웹툰/`
- 음성 클론: `REDACTED/parksy-audio/pre-season/mcp_voice/phone_rvc.py`
