...
| 19 | **Grok은 옵션이다** | LLM 비용 트랙: 0원(무료 티어) → 1만원(DeepSeek) → 5만원(Grok) |
...
**Grok 선택 이유 (월 49,000원, 비싸지만 유일하게 이걸 다 해줌):**
...
**한 줄:** Grok 49,000원이 비싸 보이지만, 이걸 각각 다른 도구(Midjourney+Runway+ChatGPT+NotebookLM)로 사면 3~4배 든다. **구형 폰 단일 구독으로 콘텐츠 생태계를 돌리는 실험.**
...
| Boss | 1+2 | 45,000원 | Grok은 Naver·디자인에도 사용 중 (추가 비용 아님) |
| 프로 | 1+2+3 | GPU만큼 | RunPod 종량제, 필요한 날만 |

**Boss 최종 통찰:**
"일반인한테는 45,000원 비싸다. 근데 트랙 1이 0원이다.
